...
const initialState = {
  ...
  theme: "light",
  item: {},
  ajwt : Cookies.get(process.env.CLIENT_AUTH_COOKIE),
  sid : Cookies.get(process.env.CLIENT_SESS_COOKIE),
  errors : {}
}
...
//NOTE: REACT-N is Incompatible with GlobalStateContext
